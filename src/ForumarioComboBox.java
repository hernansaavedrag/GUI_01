 ...
 * @author USRVI-LC3
 */
public class ForumarioComboBox extends javax.swing.JFrame {

    /**
     * Creates new form ForumarioComboBox
     */
    public ForumarioComboBox() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ForumarioComboBox.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ForumarioComboBox().setVisible(true);
            }
        });
    }
